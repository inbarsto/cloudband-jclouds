 ...
 */
@AutoValue
public abstract class UpdateStackOptions {
   ...
   public static Builder builder() {
      return new AutoValue_UpdateStackOptions.Builder();
   }

   public abstract Builder toBuilder();

   @SerializedNames({"template", "template_url", "parameters"})
   private static UpdateStackOptions create(@Nullable String template, @Nullable String templateUrl, @Nullable Map<String, Object> parameters) {
      return builder()
              .template(template)
   ...
   public abstract static class Builder {
      ...
      abstract UpdateStackOptions autoBuild();

      public UpdateStackOptions build() {
