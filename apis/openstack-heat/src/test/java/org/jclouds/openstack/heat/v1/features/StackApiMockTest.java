...
public class StackApiMockTest extends BaseHeatApiMockTest {
    ...
    public void testCreateWithTemplateUrl() throws Exception {
        ...
        try {
            ...
            CreateStackOptions createStack = CreateStackOptions.builder().name(TEST_STACK_NAME).templateUrl("http://10.5.5.121/Installs/cPaaS/YAML/simple_stack.yaml").build();
    ...
    public void testUpdateStack() throws IOException, InterruptedException {
        ...
        try {
            ...
            UpdateStackOptions updateOptions = UpdateStackOptions.builder().templateUrl("http://10.5.5.121/Installs/cPaaS/YAML/simple_stack.yaml").build();
