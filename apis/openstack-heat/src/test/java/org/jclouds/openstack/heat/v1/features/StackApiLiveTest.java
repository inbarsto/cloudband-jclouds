...
public class StackApiLiveTest extends BaseHeatApiLiveTest {
   ...
   public void testList() {
      for (String region : api.getConfiguredRegions()) {
         ...
         CreateStackOptions createStack = CreateStackOptions.builder().name(getName()).templateUrl(TEMPLATE_URL).build();
   ...
   public void testDeleteStack() {
      for (String region : api.getConfiguredRegions()) {
         ...
         CreateStackOptions createStack = CreateStackOptions.builder().name(stackName).templateUrl(TEMPLATE_URL).build();
         Stack stack = stackApi.create(createStack);
         assertThat(stack).isNotNull();
         assertThat(stack.getId()).isNotEmpty();
...
//      for (String region : api.getConfiguredRegions()) {
//         StackApi stackApi = api.getStackApi(region);
//         CreateStackOptions createStack = CreateStackOptions.builder().name(getName()).templateUrl(TEMPLATE_URL).disableRollback(false).build();
//         Stack stack = stackApi.create(createStack);
//         assertThat(stack).isNotNull();
//         assertThat(stack.getId()).isNotEmpty();
...
//
//         CreateStackOptions createStack = CreateStackOptions.builder().name(getName()).template(String.valueOf(jsonObject.get("template"))).build();
//         Stack stack = stackApi.create(createStack);
//         assertThat(stack).isNotNull();
//         assertThat(stack.getId()).isNotEmpty();
//      }
...
//
//         String stackName = getName();
//         CreateStackOptions createStack = CreateStackOptions.builder().name(stackName).template(String.valueOf(jsonObject.get("template"))).build();
//         Stack stack = stackApi.create(createStack);
//         assertThat(stack).isNotNull();
...
//         JSONObject jsonObject = (JSONObject) obj;
//
//         CreateStackOptions createStack = CreateStackOptions.builder().name(getName()).template(String.valueOf(jsonObject.get("template")))
...
//
//         CreateStackOptions createStack = CreateStackOptions.builder().name(getName())
...
//
//         String stackName = getName();
//         CreateStackOptions createStack = CreateStackOptions.builder().name(stackName).template(String.valueOf(jsonObject.get("template"))).parameters(parameters).build();
//         Stack stack = stackApi.create(createStack);
//         assertThat(stack).isNotNull();
//         assertThat(stack.getId()).isNotEmpty();
