...
public class ParseServerListDetailsTest extends BaseItemParserTest<Server> {

   @Override
   public String resource() {
      return "/server_details_list_host.json";
   }
   ...
   public Server expected() {
      return Server
            ...
            .addresses(ImmutableMultimap.<String, Address>builder()
                  ...
                  .build())
            .extendedAttributes(ServerExtendedAttributes.builder().instanceName(null).hostName("host1").hypervisorHostName(null).build())
            .build();
